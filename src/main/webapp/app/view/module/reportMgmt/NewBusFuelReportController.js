Ext.define('helloext.view.module.reportMgmt.NewBusFuelReportController', {
    extend: 'Ext.app.ViewController',
    alias:'controller.newbusfuelreportcontroller',
    requires:[
    ],
    id:'NewBusFuelReportControllerId',
    ...
    queryBranchFuelReport:function(button) {
		...
		var ed = form.lookupReference('modifyEndDate').getValue();
      	var store = Ext.getStore('NewBusFuelReportStoreId');
      	store.proxy.url = './fuelReport/getNewBusGasReportByParams';
      	store.proxy.method = 'post';
      	var new_params = { orgId:branchId,
      						queryTimeRangeStart:sd,
      						queryTimeRangeEnd:ed,
      						queryType:'QueryNewBusGasReport'};    
