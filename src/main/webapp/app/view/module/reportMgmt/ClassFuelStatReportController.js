Ext.define('helloext.view.module.reportMgmt.ClassFuelStatReportController', {
    extend: 'Ext.app.ViewController',
    alias:'controller.classfuelstatreportcontroller',
    requires:[
    ],
    id:'ClassFuelStatReportControllerId',
    ...
    queryBranchFuelReport:function(button) {
		...
		var ed = form.lookupReference('modifyEndDate').getValue();
      	var store = Ext.getStore('ClassFuelStatReportStoreId');
      	store.proxy.url = './fuelReport/getClassFuelStatReportByParams';
      	store.proxy.method = 'post';
      	var new_params = { orgId:branchId,
      						queryTimeRangeStart:sd,
      						queryTimeRangeEnd:ed,
      						queryType:'QueryClassFuelStatReport'};    
